...
import com.kubeiwu.commontool.khttp.RetryPolicy;
import com.kubeiwu.commontool.khttp.VolleyLog;
import com.kubeiwu.commontool.khttp.cache.Cache;
import com.kubeiwu.commontool.khttp.exception.AuthFailureError;
import com.kubeiwu.commontool.khttp.exception.NetworkError;
import com.kubeiwu.commontool.khttp.exception.NoConnectionError;
import com.kubeiwu.commontool.khttp.exception.ServerError;
		...
		while (true) {// 这里的while是重试用，如果不重试，会拋异常退出while循环
			...
			try {
				...
				if (responseContents != null) {
					...
					throw new NetworkError(e);// bug修改 networkResponse这里是null,所以是哟个e更合理
